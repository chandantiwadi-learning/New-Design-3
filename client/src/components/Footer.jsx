        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-start">
            ...
            <div className="flex flex-col space-y-6 lg:col-span-3">
              ...
              <div className="bg-gradient-to-br from-[#0D8BC5]/5 to-[#0D8BC5]/10 p-6 rounded-[16px] border border-[#0D8BC5]/20 flex flex-col items-center justify-center text-center group hover:shadow-[0_8px_24px_rgba(30,136,229,0.12)] transition-all">
                ...
                <a href="#" className="w-full py-2.5 bg-white border border-[#0D8BC5]/30 rounded-lg text-[#0D8BC5] text-xs font-bold hover:bg-[#0D8BC5] hover:text-white transition-colors flex items-center justify-center gap-2 shadow-sm">
