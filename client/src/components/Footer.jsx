          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-start">
            ...
            <div className="flex flex-col space-y-6 lg:col-span-3">
              ...
              <div className="bg-gradient-to-br from-[#25D366]/5 to-[#25D366]/10 p-6 rounded-[16px] border border-[#25D366]/20 flex flex-col items-center justify-center text-center group hover:shadow-[0_8px_24px_rgba(37,211,102,0.12)] transition-all">
                ...
                <a href="https://api.whatsapp.com/send?phone=912235346200&text=Hello%20HEX%20INDIA%20Fasteners" target="_blank" rel="noopener noreferrer" className="w-full py-2.5 bg-[#25D366] border border-[#25D366] rounded-lg text-white text-xs font-bold hover:bg-[#1DA851] transition-colors flex items-center justify-center gap-2 shadow-sm mb-2">
                  Chat Now
                </a>
                <a href="#" className="w-full py-2 bg-white border border-gray-200 rounded-lg text-gray-600 text-xs font-bold hover:bg-gray-50 transition-colors flex items-center justify-center gap-2 shadow-sm">
