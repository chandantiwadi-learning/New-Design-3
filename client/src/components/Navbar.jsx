...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <div className={`fixed top-0 bottom-0 right-0 z-[120] w-[85%] max-w-sm bg-white shadow-2xl transform transition-transform duration-300 ease-in-out md:hidden flex flex-col h-[100dvh] ${isMobileMenuOpen ? 'translate-x-0' : 'translate-x-full'}`}>
