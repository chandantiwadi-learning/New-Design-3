              ...
              <blockquote className="space-y-6 relative z-10">
                ...
                <div className="flex items-center gap-4 md:pl-14 pl-12">
                  <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-white flex items-center justify-center border border-[#0D8BC5]/20 shadow-sm flex-shrink-0">
                    <i className="icon-user text-[#0D8BC5] text-lg md:text-xl"></i>
                  </div>
                  <div>
                    <div className="font-extrabold text-gray-900 text-sm md:text-base tracking-wide uppercase">ROMEO SHANNON</div>
                    <div className="text-[#0D8BC5] text-[10px] md:text-xs font-bold uppercase tracking-[0.2em] mt-1">QC Laboratory Manager</div>
                  </div>
                </div>
              </blockquote>
            </motion.div>
