              ...
              <blockquote className="space-y-6 relative z-10 pt-2 pl-4 md:pl-8">
                ...
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-full bg-[#0D8BC5]/10 flex items-center justify-center">
                    <i className="icon-user text-[#0D8BC5] text-xl"></i>
                  </div>
                  <div>
                    <div className="font-extrabold text-gray-900 text-sm md:text-base tracking-wide">ROMEO SHANNON</div>
                    <div className="text-[#0D8BC5] text-xs font-bold uppercase tracking-[0.2em] mt-1">QC Laboratory Manager</div>
                  </div>
                </div>
              </blockquote>
            </motion.div>
